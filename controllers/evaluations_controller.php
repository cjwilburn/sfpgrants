...
class EvaluationsController extends AppController {
	...
	var $name = 'Evaluations';
        var $uses = array('Evaluation', 'Proposal', 'User', 'Merit2011');
	...
	function delete($id = null) {
        ...
        function admin_large(){
	        ...
	        $this->loadModel('Proposal');
			 $this->Evaluation->recursive = 0;
			//$this->set('evaluations', $this->paginate());
			$this->paginate = array('conditions'=> array('Evaluation.date_submitted >='=>'2011-01-31 00:00:00', 'Proposal.project_type_id' => 2));
	        $this->set('evaluations', $this->paginate('Evaluation'));
        }
	    ...
	    function admin_small(){
			$this->loadModel('User');
			 ...
			 $this->Evaluation->recursive = 0;
			//$this->set('evaluations', $this->paginate());
			$this->paginate = array('conditions'=> array('Evaluation.date_submitted >='=>'2011-01-31 00:00:00', 'Proposal.project_type_id' => 1));
	        $this->set('evaluations', $this->paginate('Evaluation'));
	    }
