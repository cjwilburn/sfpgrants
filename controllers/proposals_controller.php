...
class ProposalsController extends AppController {
	...
	var $name = 'Proposals';
        var $uses = array('Proposal', 'User', 'Evaluation', 'UsersProposal', 'Merit2011', 'AverageMerit2011');
...
//var $large = $this->Proposal->find('all', array('conditions'=> array('project_type_id'=> '2')));
	...
	function delete($id = null) {
		...
		$this->set(compact('users'));
                ...
                $upload = $this->Proposal->Upload->find('list');
                $this->set('upload', $upload);
        $merits = $this->Proposal->Merit2011->findByProposal('merit');
        $this->set('merits', $merit);
        }
        ...
        function admin_index() {
            $this->loadModel('Merit2011');
		       $this->loadModel('AverageMerit2011');
        ...
        $averages = $this->Proposal->AverageMerit2011->find('all', array('conditions' => array('AverageMerit2011.proposal_id'=> $this->Proposal->id)));
		...
		$this->set('proposal', $this->Proposal->read(null, $id));
		$evaluations = $this->Proposal->Evaluation->find('list', array('conditions' => array('Evaluation.proposal_id'=>'Proposal.id')));
      ...
      $evaluations = $this->Proposal->Evaluation->find('list', array('conditions' => array('Evaluation.proposal_id'=>'Proposal.id')));
       ...
       function board_small(){
        ...
        $this->set('proposals', $this->paginate('Proposal'));
       $evaluations = $this->Proposal->Evaluation->find('list', array('conditions' => array('Proposal.id'=>'Evaluation.proposal_id')));
       $this->set(compact('evaluations'));
       }
