<div class="chairLargeRanks index">
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $chairLargeRank['ChairLargeRank']['project_type']; ?>&nbsp;</td>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $chairLargeRank['ChairLargeRank']['avg_merit'])); ?>
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $chairLargeRank['ChairLargeRank']['avg_merit'])); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $chairLargeRank['ChairLargeRank']['avg_merit']), null, sprintf(__('Are you sure you want to delete # %s?', true), $chairLargeRank['ChairLargeRank']['avg_merit'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
