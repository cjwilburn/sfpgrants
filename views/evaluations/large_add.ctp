...
<div class="grid_12">
	...
	<?php echo $this->Form->create('Evaluation');?>
		...
		echo $this->Form->input('user_id', array('options'=>$large_users, 'default'=>($this->Session->read('Auth.User.id'))));
		echo $this->Form->input('proposal_id', array('options'=>$large_proposals, 'default'=> ($this->Session->read(''))));
