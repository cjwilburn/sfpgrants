...
<div class="grid_12">
	...
	<div class="box">
        ...
        echo $this->Html->tag('li');
        echo $this->Html->link('View all small proposal evaluations', array('controller'=>'evaluations', 'action'=> 'small', 'admin'=>true));
        echo $this->Html->tag('li');
        echo $this->Html->link('View all large proposal evaluations', array('controller'=>'evaluations', 'action'=> 'large', 'admin'=>true));
        echo $this->Html->tag('li');
	    echo $this->Html->link('View small grants ranked by average merit score', array('controller'=>'admin_small_ranks', 'action'=>'index', 'admin'=>true));
	    echo $this->Html->tag('li');
	    echo $this->Html->link('View large grants ranked by average merit score', array('controller'=>'admin_large_ranks', 'action'=>'index', 'admin'=>true));
