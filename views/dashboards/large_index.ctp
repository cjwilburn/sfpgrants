...
<div class="grid_12">
	...
	<div class="box">
        ...
        echo $this->Html->link('View all large grant submissions', array('controller'=>'proposals', 'action'=>'index', 'large'=>true));
         echo $this->Html->tag('li');
	    echo $this->Html->link('View large grants ranked by average merit score', array('controller'=>'large_grant_ranks', 'action'=>'index', 'large'=>true));
        echo $this->Html->tag('li');
        echo $this->Html->link('View grants that you will be evaluating', array('controller'=>'users_proposals', 'action'=> 'index', 'large'=>true));
        echo $this->Html->tag('li');
