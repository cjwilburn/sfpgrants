...
<div class="grid_12">
    ...
    <?php $tableHeaders = $html->tableHeaders(array($paginator->sort('id'),$paginator->sort('date_submitted'),$paginator->sort('project_type'),$paginator->sort('budget_award_award_amount'),$paginator->sort('project_budget'),$paginator->sort('project_title'),$paginator->sort('average_merit_score'),__('Actions', true),));
