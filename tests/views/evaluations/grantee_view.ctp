<div class="grid_4">
	<div class="box">
		...
		<div class="block" id="admin-actions">
			<h5>Evaluations</h5>
			<ul class="menu">
				<li><?php echo $this->Html->link(sprintf(__('Edit %s', true), __('Evaluation', true)), array('action' => 'edit', $evaluation['Evaluation']['id'])); ?> </li>
				<li><?php echo $this->Html->link(sprintf(__('Delete %s', true), __('Evaluation', true)), array('action' => 'delete', $evaluation['Evaluation']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $evaluation['Evaluation']['id'])); ?> </li>
