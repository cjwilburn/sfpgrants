<div class="grid_4">
	<div class="box">
		...
		<div class="block" id="admin-actions">
			<h5>Evaluations</h5>
			<ul class="menu">
				<li><?php echo $this->Html->link(sprintf(__('New %s', true), __('Evaluation', true)), array('action' => 'add')); ?></li>
			</ul>
...
<div class="grid_12">
    ...
    <?php $tableHeaders = $html->tableHeaders(array($paginator->sort('id'),$paginator->sort('date_submitted'),$paginator->sort('users_id'),$paginator->sort('proposals_id'),$paginator->sort('research_plan'),$paginator->sort('significance'),$paginator->sort('qualifications'),$paginator->sort('environment'),$paginator->sort('funder_absence'),$paginator->sort('budget_timeline'),$paginator->sort('responsiveness'),$paginator->sort('comments'),$paginator->sort('summary'),$paginator->sort('merit'),__('Actions', true),));
...
<?php
	...
	<tr<?php echo $class;?>>
		...
		<td>
			<?php echo $this->Html->link($evaluation['Users']['id'], array('controller' => 'users', 'action' => 'view', $evaluation['Users']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($evaluation['Proposals']['id'], array('controller' => 'proposals', 'action' => 'view', $evaluation['Proposals']['id'])); ?>
		</td>
