...
<div class="grid_12">
	...
	<?php echo $this->Form->create('UsersProposal');?>
		...
		echo $this->Form->input('Users_proposal.0.user_id', array('options'=>$small_users));
		echo $this->Form->input('Users_proposal.0.proposal_id', array('options'=>$small_proposals));
